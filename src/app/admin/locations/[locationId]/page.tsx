  ...
  return (
    <div>
      ...
      {(!courts || courts.length === 0) && (
        <p className="mt-1 text-sm text-fg-muted">No courts yet. Add one below.</p>
      )}
      ...
      {canManage && (
        <>
          ...
          <form action={createCourt} className="mt-3 flex flex-col gap-3">
            ...
            <label className="flex flex-col gap-1 text-sm">
              Surface type
              <input name="surface_type" className="rounded border border-border px-3 py-2" />
            </label>
            <label className="flex flex-col gap-1 text-sm">
              Court notes (optional, shown to players)
              <textarea name="notes" rows={2} className="rounded border border-border px-3 py-2" />
            </label>
            <label className="flex flex-col gap-1 text-sm">
              Booking block size
              <select name="slot_size_minutes" defaultValue="60" className="rounded border border-border px-3 py-2">
                <option value="60">Full hour</option>
                <option value="30">Half hour</option>
              </select>
            </label>
